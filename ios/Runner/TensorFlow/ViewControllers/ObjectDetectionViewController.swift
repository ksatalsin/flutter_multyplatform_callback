...
extension ObjectDetectionViewController: InferenceViewControllerDelegate {
...
extension ObjectDetectionViewController: CameraFeedManagerDelegate {
...
extension ObjectDetectionViewController {
  ...
  private func addPanGesture() {
    let panGesture = UIPanGestureRecognizer(target: self, action: #selector(ObjectDetectionViewController.didPan(panGesture:)))
